  ...
  return (
    <div style={{display:'flex',flexDirection:'column',gap:16}}>
      <div style={{background:'rgba(124,106,247,.08)',border:'1px solid rgba(124,106,247,.2)',borderRadius:10,padding:14}}>
        <div style={{fontSize:11,fontWeight:700,color:'var(--acc)',letterSpacing:1,marginBottom:8}}>SINTESE AI â ultimas 24h</div>
...
function InsidersPanel({ tickers }) {
  ...
  return (
    <div style={{display:'flex',flexDirection:'column',gap:16}}>
      <div className="card">
        <h2 style={{marginBottom:14}}>Insiders â Volume Total do Mercado</h2>
